  ...
  <div class="page-container">
    <el-form :model="queryParams" inline class="search-form">
      ...
      <el-form-item label="分站">
        <el-input v-model="queryParams.stationId" placeholder="请输入分站ID" clearable />
      </el-form-item>
    ...
    <el-table :data="tableData" v-loading="loading" border stripe>
      ...
      <el-table-column prop="stationName" label="分站名称" width="150" />
...
import { getTasks } from '@/api/dispatch'
...
const handleReset = () => {
  Object.assign(queryParams, {
    page: 1, size: 10, taskCode: '', taskType: '',
    taskStatus: '', stationId: '', startDate: '', endDate: ''
  })
  fetchData()
}
